...

{
    ...
    const quizSet = shuffle([
        ...
        {q:'ウォーターフォール', c:['最初に行った設計通りに開発する手法','PDCAを回しながら開発する手法','ユーザー第一の開発手法']},
        {q:'アジャイル', c:['修正・改善を繰り返す開発手法','設計通りに開発する手法','1人で開発する手法']},
        {q:'CPU', c:['コンピュータの中心的な機能','コンピュータの容量','通信速度']},
        {q:'DOM', c:['JavaScriptからHTMLを操作するもの','データの容量','セキュリティ方式']},
        {q:'GUI', c:['視覚的に操作できるもの','コマンドだけでコンピュータを操作すること','最大値を取得する']},
        {q:'3*4', c:['12','7','-1']},
        {q:'document.getElementById', c:['HTMLからid要素を取得','idタグの効果を無効にする','idタグを追加する']},
        {q:'for', c:['繰り返し処理を行う','画像のスライドを行う','ユーザーファーストの考え方']},
    ]);
    // 変数currentNumに0を格納
    let currentNum = 0;
    // 変数isAnswerdを定義
